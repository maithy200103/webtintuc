...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Sau khi đăng nhập admin/biên tập viên thành công:
      ...
      if (data.user.role === 'Admin') {
        navigate('/admin/taotaikhoan');
      } else if (data.user.role === 'Biên tập viên') {
        navigate('/bientapvien/soanthao');
      } else {
